...
export default function PromptEditor({
  ...
  return (
    <section className="flex h-full flex-col overflow-hidden rounded-2xl border border-stone-800 bg-stone-950/60">
      {/* Tab bar */}
      <div className="flex items-center justify-between gap-3 border-b border-stone-800/80 bg-stone-900/40 px-4 py-2.5">
        <div className="flex items-center gap-2 rounded-lg border border-amber-500/25 bg-amber-500/10 px-3 py-1.5 text-sm text-amber-200">
